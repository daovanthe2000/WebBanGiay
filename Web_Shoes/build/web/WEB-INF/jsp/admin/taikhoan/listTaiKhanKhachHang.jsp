                                            ...
                                            <div class="table-responsive">
                                                <table id="khuyenmai" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <c:forEach var="c" items="${bn}">
                                                        <tr>
                                                            <td class="khachhang" data-ma="${c.maKhachHang}">${c.maKhachHang}</td>
                                                            <td>${c.hoTen}</td>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $(".huydon").click(function () {
                    ...
                    var maKhachHang = $(this).closest("tr").find(".khachhang").attr("data-ma");
                    var status = $(".huy11").val();

                    $.ajax({
                        url: "${pageContext.request.contextPath}/admin/taikhoan/updatetintrangkh",
                        type: "GET",
                        data: {
                        ...
                        success: function (value) {
                            ...
                            if (value==true) {
                                ...
                                toastr.error('tài khoản này đang ở chúc vự quản lý không thể khóa tài khoản!', 'Error!', {
                                    closeButton: true,
                                    tapToDismiss: false
                                });
                            }
